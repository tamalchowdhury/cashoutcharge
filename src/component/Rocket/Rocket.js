...
export default function Rocket({ text }) {
              ...
              {amount && (
                ...
                */}
                    {lang === "bn"
                      ...
                      : parseInt(amount).toLocaleString("en-IN")}{" "}
                    {text(
                      "Taka Rocket Cashout Charge is",
                      "টাকা রকেট ক্যাশআউট চার্জ"
                    )}{" "}
                    {lang === "bn"
                      ? parseInt(fee).toLocaleString("bn-IN")
                      : parseInt(fee).toLocaleString("en-IN")}{" "}
                  ...
                  <ul>
                    ...
                    <li>
                      {text(
                        ...
                        } থেকে রকেট চার্জ ${rate.toLocaleString("bn-IN")}%`
                      )}
                    </li>
                  </ul>
                </div>
