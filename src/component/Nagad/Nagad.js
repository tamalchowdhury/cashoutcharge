...
export default function Nagad({ text }) {
  ...
  return (
    <>
      <HelmetProvider>
        <Helmet>
          <title>Nagad Cashout Calculator - নগদ ক্যাশআউট ক্যালকুলেটর</title>
          <meta
            name="description"
            content="Use this free Nagad cashout calculator to check the charge"
          />
        </Helmet>
        <div className="shell nagad--theme">
          <div className="form">
